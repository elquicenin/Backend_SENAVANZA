from .api import user_create, user_empresa_list, user_empresa_detail,user_empresa_create, user_empresa_update, programa_list, programa_create, programa_detail, user_detail
...
urlpatterns = [ 
    ...
    path('programa/', programa_list, name='programa_list'),
